...
def get_daq_parameters(ro_dur=7000,IQangle=90):
    ...
    #        
    daq_params.iq_angle_deg = IQangle #100#-43.1-180+20-29+35 +180 + 60#+145#+60#+75+45
    ...
    daq_params.readout_start = 1100 #1100
    daq_params.readout_duration =ro_dur #120#200# 140 #1000
