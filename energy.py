...
plt.plot(tan_qb_13[:len(wxsteps)-1], work13[:len(wxsteps)-1], label = "W = 13 MHz", linestyle = "dashed");plt.plot(tan_qb_13[:len(wxsteps)-1], work20[:len(wxsteps)-1], label = "W = 20 MHz", linestyle = "dashed");plt.legend()
