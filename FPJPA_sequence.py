...
ro_pulse_dur = 5000
readout_amp_1 = 0.134*0.5*1.83
readout_amp_2 = 0.134*0.6
...
def pi_nopi(coef=0,off=0,pi_ge=24,ssm_ge = -0.04575, q=0,r=0, ROIF=0.01): #this is pulsed readout to ring up and ring down cavity dfor e state
...
#    ringupdown_seq.add_sweep(channel=1, marker=2, sweep_name='none', initial_pulse=gate_trigger )
    ...
    #Q1 Readout
    if r == 1:
        main_pulse = Pulse(start = file_length- readout_dur,duration= readout_dur, amplitude= 1.3*readout_amp_1,ssm_freq=ROIF, phase=-file_length*ROIF*360) 
        ringupdown_seq.add_sweep(channel=1, sweep_name='none',initial_pulse=main_pulse) 
        
    #Q2 Readout
    if r == 0:
        main_pulse = Pulse(start = file_length- readout_dur,duration= readout_dur, amplitude=1.3*readout_amp_2,ssm_freq=ROIF, phase=-file_length*ROIF*360 ) 
        ringupdown_seq.add_sweep(channel=1, sweep_name='none',initial_pulse=main_pulse)
