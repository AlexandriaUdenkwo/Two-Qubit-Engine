...
def run_daq2(num_patterns=None, num_records_per_pattern=None, verbose=True):
    ...
    (rec_avg_all, rec_readout) = daq_alazar.acquire_data(daq_params, alazar_params, board, verbose=True)
...
def run_daq_het(ssm_if=0.02, num_patterns=None, num_records_per_pattern=None, verbose=True):
    # get parameters: number of patterns, etc.
    daq_params = get_daq_parameters(num_patterns=num_patterns, 
                                    num_records_per_pattern=num_records_per_pattern)
    ...
    daq_alazar.configure_board(alazar_params, board)
    #print("\nTroubleshoot stuck at this step 3")
    (rec_avg_all, rec_readout, rec_all, rec_all_het) = daq_alazar.acquire_data_het(daq_params, alazar_params, board, ssm_if, verbose=True)
    #print(alazar_params.buffer_count)
    #print("\nTroubleshoot stuck at this step 4")
    # reshape the records
    rec_readout_vs_pats = daq_processing.record_vs_patterns(daq_params, rec_readout)
...
#2Qubit_DAQ
def run_daq_het_2q(ssm_if_1=-0.04, ssm_if_2=0.10692, deg_1 = 0, deg_2 = 0, num_patterns=None, num_records_per_pattern=None, verbose=True):
    # get parameters: number of patterns, etc.
    daq_params = get_daq_parameters(num_patterns=num_patterns, 
                                    num_records_per_pattern=num_records_per_pattern)
    ...
    daq_alazar.configure_board(alazar_params, board)
    #print("\nTroubleshoot stuck at this step 3")
    (rec_avg_all, rec_readout_1, rec_readout_2, rec_all, rec_all_het_1, rec_all_het_2) = daq_alazar.acquire_data_het_2q(daq_params, alazar_params, board, ssm_if_1, ssm_if_2, deg_1, deg_2, verbose=True)
    #print(alazar_params.buffer_count)
    #print("\nTroubleshoot stuck at this step 4")
    # reshape the records
...
#    n_vs_pats_2, prob_vs_pats_2 = daq_processing.readout_vs_patterns(daq_params, n_readout_2)
    ...
    #return rec_avg_all, rec_readout, rec_avg_vs_pats
    return rec_avg_all, rec_all, rec_readout_1, rec_readout_2, rec_avg_vs_pats_1, rec_avg_vs_pats_2 , rec_all_het_1, rec_all_het_2, bins_1, bins_2, counts_1, counts_2

def run_daq_het_2q_prob(ssm_if_1=-0.04, ssm_if_2=0.10692, deg_1 = 0, deg_2 = 0, svm_coeff_1 = None, svm_coeff_2 = None, num_patterns=None, num_records_per_pattern=None, verbose=True):
    # get parameters: number of patterns, etc.
    daq_params = get_daq_parameters(num_patterns=num_patterns, 
                                    num_records_per_pattern=num_records_per_pattern)
    ...
    # threshold the readout signal for every record (channel a)
    n_readout_1 = daq_processing.threshold_record_averages_svm(signal_in=rec_readout_1, svm_coeff = svm_coeff_1)
    n_vs_pats_1, prob_vs_pats_1 = daq_processing.readout_vs_patterns(daq_params, n_readout_1)
    
    n_readout_2 = daq_processing.threshold_record_averages_svm(signal_in=rec_readout_2, svm_coeff = svm_coeff_2)
    n_vs_pats_2, prob_vs_pats_2 = daq_processing.readout_vs_patterns(daq_params, n_readout_2)
    ...
    #return rec_avg_all, rec_readout, rec_avg_vs_pats
    return rec_avg_all, rec_all, rec_readout_1, rec_readout_2, rec_avg_vs_pats_1, rec_avg_vs_pats_2 , rec_all_het_1, rec_all_het_2, bins_1, bins_2, counts_1, counts_2, prob_vs_pats_1, prob_vs_pats_2, n_readout_1, n_readout_2
